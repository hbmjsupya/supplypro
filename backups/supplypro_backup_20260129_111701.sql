...
INSERT INTO `brand_supplier` VALUES (1,1),(3,1),(1,9),(1,10),(3,10),(1,14),(3,14);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='客户信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='入库单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `logistics_providers` VALUES (1,'顺丰速运','王卫','95338','ACTIVE','2026-01-28 05:19:30','2026-01-28 05:19:30'),(2,'京东物流','刘强东','950616','ACTIVE','2026-01-28 05:19:30','2026-01-28 05:19:30');
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=117 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='采购订单明细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='销售订单明细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='销售订单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='库存批次表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='库存流水表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `supplier_accounts` VALUES (1,'1231231231231231','ABC',_binary '\0','测试供应商',_binary '','PERSONAL',1),(2,'1231231231231231','ABC',_binary '\0','测试供应商',_binary '','PERSONAL',1),(3,'1231231231231231','ABC',_binary '\0','测试供应商',_binary '','PERSONAL',1),(4,'1234567890','Test Bank',_binary '\0','Test Account 1 Updated',_binary '','COMPANY',9),(5,'1231231231231231','ABC',_binary '\0','测试供应商01',_binary '','COMPANY',10),(6,'342342342','中国建设银行',_binary '\0','于涛',_binary '','PERSONAL',14),(7,'1231231231231231','中国农业银行',_binary '\0','测试供应商02',_binary '','COMPANY',14),(8,'2342342','交通银行',_binary '\0','萨达',_binary '','PERSONAL',19);
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='供应商信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `suppliers` VALUES (1,'GYS0000001','测试供应商','于涛','13241672829','CASH',7,NULL,'ACTIVE','2026-01-28 09:08:28','2026-01-29 01:00:33',NULL,'我的','110000','110101',NULL,NULL,NULL,NULL,1,'2026-02-06 16:00:00','2026-01-28 16:00:00','于涛','13241672829',NULL),(2,'GYS0000002','Test Supplier 1','John Doe','13800138001','CASH',NULL,NULL,'ACTIVE','2026-01-28 09:11:14','2026-01-28 09:18:41','john@example.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(3,'GYS0000003','Supplier-Expiring-Test','Test Contact','13900009999','CASH',30,NULL,'ACTIVE','2026-01-28 09:42:31','2026-01-28 09:42:31',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-02-14 16:00:00','2025-12-31 16:00:00',NULL,NULL,NULL),(4,'GYS0000004','Supplier_Receiver_Test','Test Contact','13800000002','CASH',30,NULL,NULL,'2026-01-28 09:52:16','2026-01-28 09:52:16',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2024-12-31 15:59:59','2023-12-31 16:00:00','Receiver Two','13900000002',NULL),(5,'GYS0000005','Expiring_Supplier_A','Test Contact','13800000003','CASH',30,NULL,NULL,'2026-01-28 09:52:27','2026-01-28 09:52:27',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-02-06 16:00:00','2024-12-31 16:00:00',NULL,NULL,NULL),(6,'GYS0000006','Non_Expiring_Supplier_B','Test Contact','13800000004','CASH',30,NULL,NULL,'2026-01-28 09:52:35','2026-01-28 09:52:35',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-08 16:00:00','2024-12-31 16:00:00',NULL,NULL,NULL),(7,'GYS0000007','Safe Supplier Test','Contact Two','13800138002','CASH',NULL,NULL,'ACTIVE','2026-01-28 09:55:48','2026-01-28 09:55:48','safe@test.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-08 16:00:00','2025-12-31 16:00:00','Receiver Two','13800138002',NULL),(8,'GYS0000008','Expiring Supplier Test Retry','Contact One','13800138003','CASH',NULL,NULL,'ACTIVE','2026-01-28 09:55:59','2026-01-28 09:55:59','expiring_retry@test.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-02-06 16:00:00','2025-12-31 16:00:00','Receiver One','13800138003',NULL),(9,'GYS0000009','Full Feature Supplier Updated','Contact Full','13800138004','PREPAYMENT',NULL,NULL,NULL,'2026-01-28 09:56:27','2026-01-29 01:05:46',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Receiver Updated','13900000000',5000.00),(10,'GYS0000010','测试供应商01','于涛','13241762829','CASH',7,NULL,'ACTIVE','2026-01-29 02:25:23','2026-01-29 02:25:23',NULL,'十大','110000','110101',NULL,NULL,NULL,NULL,1,'2026-02-18 16:00:00','2026-01-28 16:00:00','于涛','13241672829',NULL),(11,'GYS0000011','Duplicate Test Supplier','Test Person','13800138999','CASH',NULL,NULL,NULL,'2026-01-29 02:34:30','2026-01-29 02:34:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(13,'GYS0000012','Different Name','Test Person','13800138999','CASH',NULL,NULL,NULL,'2026-01-29 02:35:39','2026-01-29 02:35:39',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(14,'GYS0000013','测试供应商02','于涛','13241672829','CASH',7,NULL,'ACTIVE','2026-01-29 02:38:08','2026-01-29 02:38:08',NULL,'我的','110000','110101',NULL,NULL,NULL,NULL,1,'2026-02-04 16:00:00','2026-01-28 16:00:00','于涛','13241672829',NULL),(15,'GYS0000014','Test Full Supplier Updated','Tester Updated','13900001111','PREPAYMENT',NULL,NULL,NULL,'2026-01-29 02:40:40','2026-01-29 02:43:36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Receiver Bob','13900002222',2000.00),(16,'GYS0000015','Test Non-Expiring','Tester','13900003333','CASH',NULL,NULL,NULL,'2026-01-29 02:41:00','2026-01-29 02:41:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-29 16:00:00',NULL,NULL,NULL,NULL),(19,'GYS0000016','测试供应商03','于涛','13241672829','PREPAYMENT',NULL,NULL,'ACTIVE','2026-01-29 02:53:31','2026-01-29 02:56:20',NULL,'我的','110000','110102',NULL,NULL,NULL,NULL,1,'2026-02-09 16:00:00','2026-01-28 16:00:00','于涛','13241672829',10000.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='仓库信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-29 11:17:02
