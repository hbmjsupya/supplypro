...
public class SecurityConfig {
     ...
     * When false (default): all API endpoints are publicly accessible (current behavior).
     * When true: write operations (POST/PUT/DELETE/PATCH) require JWT authentication,
     *            while GET requests and public endpoints remain open.
     */
    @Value("${supplypro.security.strict-mode:false}")
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        if (strictMode) {
            // =============================================
            // STRICT MODE: write operations require authentication
            // =============================================
            ...
            // =============================================
            // PERMISSIVE MODE (default): all APIs publicly accessible
            // =============================================
            http.authorizeRequests()
                .antMatchers("/api/auth/**").permitAll()
                .antMatchers("/api/test/**").permitAll()
